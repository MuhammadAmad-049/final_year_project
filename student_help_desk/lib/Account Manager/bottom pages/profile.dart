...
class AM_Profile extends StatefulWidget {
  @override
  MapScreenState createState() => MapScreenState();
}

class MapScreenState extends State<AM_Profile> {
  void dispose(){
    super.dispose();
    email.dispose();
    password.dispose();
  ...
  Future<bool> fetch()async{
    List admin=[];
    await FirebaseFirestore.instance.collection("admin").where("type", isEqualTo: "am").get().then((querysnapshot) {
