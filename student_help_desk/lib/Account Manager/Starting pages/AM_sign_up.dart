...
import 'AM_login.dart';


class AM_Sign_up extends StatefulWidget {
  const AM_Sign_up({Key? key}) : super(key: key);

  @override
  _AM_Sign_upState createState() => _AM_Sign_upState();
}

class _AM_Sign_upState extends State<AM_Sign_up> {
  @override
