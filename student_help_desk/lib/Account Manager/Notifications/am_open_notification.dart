...
import 'am_notifications.dart';


class AM_Open_Notificatons extends StatefulWidget {
  Map complaint;
  var studentkey;
  AM_Open_Notificatons(this.studentkey,this.complaint,{Key? key}) : super(key: key);

  @override
  _AM_Open_NotificatonsState createState() => _AM_Open_NotificatonsState(this.studentkey,this.complaint);
}

class _AM_Open_NotificatonsState extends State<AM_Open_Notificatons> {
  _AM_Open_NotificatonsState(this.complaint_key,this.singlecomplaints){}
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => AM_Notifications()),
            );
          },
        ),
        centerTitle: true,
            ...
            child: Container(
              ...
              child: ListView(
                  children: <Widget>[
                    ...
                    Container(child: Image.network(singlecomplaints['picture']))
                  ]
              ),
            ),
          ),
