...
class rm_rejected_reports extends StatefulWidget {
  const rm_rejected_reports({Key? key}) : super(key: key);

  @override
  State<rm_rejected_reports> createState() => _rejected_reportsState();
}

class _rejected_reportsState extends State<rm_rejected_reports> {
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        children: [
                                          Text(
                                            '${rejected_complaints[index]["type"]}',
                                            softWrap: false,
                                          ...
                                          SizedBox(height: 5,),
                                          Text(
                                            '${rejected_complaints[index]["student_name"]}',
                                            softWrap: false,
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 1,
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          Text(
                                            '${rejected_complaints[index]["student_reg"]}',
