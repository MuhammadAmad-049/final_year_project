...
class rm_accepted_reports extends StatefulWidget {
  const rm_accepted_reports({Key? key}) : super(key: key);

  @override
  State<rm_accepted_reports> createState() => _accepted_reportsState();
}

class _accepted_reportsState extends State<rm_accepted_reports> {
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        children: [
                                          Text(
                                            '${accepted_complaints[index]["type"]}',
                                            softWrap: false,
                                          ...
                                          SizedBox(height: 5,),
                                          Text(
                                            '${accepted_complaints[index]["student_name"]}',
                                            softWrap: false,
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 1,
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          Text(
                                            '${accepted_complaints[index]["student_reg"]}',
