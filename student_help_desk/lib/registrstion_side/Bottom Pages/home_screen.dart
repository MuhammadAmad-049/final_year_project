...
import 'package:fyp/registrstion_side/Starting%20pages/accepted_reports.dart';

import '../Notifications page/rm_notifications.dart';
import '../Starting pages/forward _reports.dart';
import '../Starting pages/rejected_reports.dart';
import '../total_reports.dart';
class RM_Home_Screen extends StatefulWidget {
  const RM_Home_Screen({Key? key}) : super(key: key);

  @override
  _RM_Home_ScreenState createState() => _RM_Home_ScreenState();
}

class _RM_Home_ScreenState extends State<RM_Home_Screen> {
                  ...
                  child: Stack(children: [
                    ...
                    Align(alignment: Alignment.topRight,
                      child: Container(
                        ...
                        child: Center(
                          child: Text("${registration_compalint.length}",
                    ...
                    Row(
                        ...
                        children: [
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          ):Text("${registration_compalint.length}",textAlign: TextAlign.center,
                          ...
                          TextButton(onPressed: (){
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => rm_accepted_reports()),
                            );
                          },
                            child: Container(
                              padding: EdgeInsets.fromLTRB(5, 5, 5, 5),
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(onPressed: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => rm_rejected_reports()),
                          );
                        },
                          child: Container(
                            padding: EdgeInsets.fromLTRB(5, 5, 5, 5),
                        ...
                        TextButton(onPressed: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => rm_forward()),
                          );
                        },
                          child: Container(
                            padding: EdgeInsets.fromLTRB(5, 5, 5, 5),
...
class CustomSearchDelegate extends SearchDelegate{
  ...
  CustomSearchDelegate(){
    FirebaseFirestore
        .instance
        .collection("complaint").where("type", isEqualTo: "registration")
        .get().then((querySnapshot) {
      querySnapshot.docs.forEach((result) {
