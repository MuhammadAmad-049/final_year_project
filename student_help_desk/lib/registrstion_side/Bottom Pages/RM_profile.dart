...
class RM_ProfilePage extends StatefulWidget {
  @override
  MapScreenState createState() => MapScreenState();
}

class MapScreenState extends State<RM_ProfilePage> {
  ...
  Future<bool> fetch()async{
    List admin=[];
    await FirebaseFirestore.instance.collection("admin").where("type", isEqualTo: "rm").get().then((querysnapshot) {
