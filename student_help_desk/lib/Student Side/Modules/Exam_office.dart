...
class ExamOffice extends StatefulWidget {
  @override
  _ExamOfficeState createState() => _ExamOfficeState();
}

class _ExamOfficeState extends State<ExamOffice> {
  bool first=true;
  bool _loading=false;
  bool uploaded=false;
  ...
  final items = ['BSCS','BSSE','BBA','BS Math','MCS',];
  File? pickedImage;
  late String depart="";
  String? value;
  ...
  TextEditingController dropdown_controller = new TextEditingController();
  String? imageUrl;
  ...
  Future<void> upload() async{
    ...
    await imageUpload();
    String? uid;
    DocumentReference dc= await FirebaseFirestore.instance.collection("complaint").doc(uid);
