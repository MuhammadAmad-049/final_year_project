...
class Registration_Office extends StatefulWidget {
  @override
  _Registration_OfficeState createState() => _Registration_OfficeState();
}

class _Registration_OfficeState extends State<Registration_Office> {
