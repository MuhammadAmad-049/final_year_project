...
class Account_Office extends StatefulWidget {
  @override
  _Account_OfficeState createState() => _Account_OfficeState();
}

class _Account_OfficeState extends State<Account_Office> {
  ...
  Future<void> imageUpload() async {
    ...
    dc.set(user).whenComplete((){
      ...
      //   context: context,
      //   title: "Succeed",
      //   desc: "Your complaint has successfully sent.",
