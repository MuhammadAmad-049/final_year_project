...
import 'package:fyp/DOO%20Side/total_reports.dart';
import 'Notifications/tm_notifications.dart';
...
class TM_Home_Page extends StatefulWidget {
  const TM_Home_Page({Key? key}) : super(key: key);

  @override
  _TM_Home_PageState createState() => _TM_Home_PageState();
}

class _TM_Home_PageState extends State<TM_Home_Page> {
              ...
              child: Stack(children: [
                ...
                Align(alignment: Alignment.topRight,
                  child: Container(
                    ...
                    child: Center(
                      child: Text("${transport_compalint.length}",
                    ...
                    Row(
                        ...
                        children: [
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          ):Text("${transport_compalint.length}",textAlign: TextAlign.center,
                          ...
                          TextButton(onPressed: (){
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => Tm_accepted_reports()),
                            );
                          },
                            child: Container(
                              padding: EdgeInsets.fromLTRB(5, 5, 5, 5),
...
class CustomSearchDelegate extends SearchDelegate{
  ...
  CustomSearchDelegate(){
    FirebaseFirestore
        .instance
        .collection("complaint").where("type", isEqualTo: "transport")
        .get().then((querySnapshot) {
      querySnapshot.docs.forEach((result) {
