...
class Tm_accepted_reports extends StatefulWidget {
  const Tm_accepted_reports({Key? key}) : super(key: key);

  @override
  State<Tm_accepted_reports> createState() => _accepted_reportsState();
}

class _accepted_reportsState extends State<Tm_accepted_reports> {
