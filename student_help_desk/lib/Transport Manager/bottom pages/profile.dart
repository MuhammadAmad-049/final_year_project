...
class TM_Profile extends StatefulWidget {
  @override
  MapScreenState createState() => MapScreenState();
}

class MapScreenState extends State<TM_Profile> {
  void dispose(){
    super.dispose();
    email.dispose();
    password.dispose();
  ...
  Future<bool> fetch()async{
    List admin=[];
    await FirebaseFirestore.instance.collection("admin").where("type", isEqualTo: "tm").get().then((querysnapshot) {
