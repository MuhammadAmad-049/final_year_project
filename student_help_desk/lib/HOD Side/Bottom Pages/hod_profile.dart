...
import 'package:fyp/HOD%20Side/Starting%20pages/hod_login.dart';
...
class HOD_ProfilePage extends StatefulWidget {
  @override
  MapScreenState createState() => MapScreenState();
}

class MapScreenState extends State<HOD_ProfilePage> {
  void dispose(){
    super.dispose();
    email.dispose();
    password.dispose();
  ...
  Future<bool> fetch()async{
    List admin=[];
    await FirebaseFirestore.instance.collection("admin").where("type", isEqualTo: "hod").get().then((querysnapshot) {
