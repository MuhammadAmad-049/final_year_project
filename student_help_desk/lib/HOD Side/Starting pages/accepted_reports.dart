...
class hodaccepted_reports extends StatefulWidget {
  const hodaccepted_reports({Key? key}) : super(key: key);

  @override
  State<hodaccepted_reports> createState() => _accepted_reportsState();
}

class _accepted_reportsState extends State<hodaccepted_reports> {
            ...
            Expanded(
                child: Container(
                    ...
                    child: StreamBuilder(
                        ...
                        return ListView.builder(physics: ClampingScrollPhysics(),shrinkWrap: true,itemCount: accepted_complaints.length ,itemBuilder: (context, index){
                          return Container(
                            height: 250,
