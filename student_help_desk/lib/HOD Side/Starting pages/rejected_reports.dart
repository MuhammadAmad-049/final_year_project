...
class hodrejected_reports extends StatefulWidget {
  const hodrejected_reports({Key? key}) : super(key: key);

  @override
  State<hodrejected_reports> createState() => _rejected_reportsState();
}

class _rejected_reportsState extends State<hodrejected_reports> {
