...
import 'doo_notifications.dart';
import 'package:cloud_firestore/cloud_firestore.dart';


class DOO_Open_Notificatons extends StatefulWidget {

  Map complaint;
  var studentkey;

   DOO_Open_Notificatons(this.studentkey,this.complaint,{Key? key}) : super(key: key);

  @override
  _DOO_Open_NotificatonsState createState() => _DOO_Open_NotificatonsState(this.studentkey,this.complaint);
}

class _DOO_Open_NotificatonsState extends State<DOO_Open_Notificatons> {
 _DOO_Open_NotificatonsState(this.complaint_key,this.singlecomplaints){}
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => DOO_Notifications()),
            );
          },
        ),
        centerTitle: true,
