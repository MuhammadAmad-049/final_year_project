...
class accepted_reports extends StatefulWidget {
  const accepted_reports({Key? key}) : super(key: key);

  @override
  State<accepted_reports> createState() => _accepted_reportsState();
}

class _accepted_reportsState extends State<accepted_reports> {
