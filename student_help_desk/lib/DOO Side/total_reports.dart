...
class total_reports extends StatefulWidget {
  const total_reports({Key? key}) : super(key: key);

  @override
  State<total_reports> createState() => _total_reportsState();
}

class _total_reportsState extends State<total_reports> {
